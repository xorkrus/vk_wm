...
namespace Galssoft.VKontakteWM.CustomControlls
{
    class CommentControl : UIControl
    {
        ...
        {
            _leftPart = MasterForm.SkinManager.GetImage("PhotoComment1");
            _rightPart = MasterForm.SkinManager.GetImage("PhotoComment3");
            _centerPart = MasterForm.SkinManager.GetImage("PhotoComment2");
            ...
            _leftPartPressed = MasterForm.SkinManager.GetImage("PhotoComment1Pressed");
            _rightPartPressed = MasterForm.SkinManager.GetImage("PhotoComment3Pressed");
            _centerPartPressed = MasterForm.SkinManager.GetImage("PhotoComment2Pressed");
