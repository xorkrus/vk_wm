...
{
    class UserDataKineticListView : KineticListView<UserDataButton>
    {
        ...
        public UserDataKineticListView()
        ...
        /// </summary>
        public List<UserDataButton> DataSource
        {
            get;
            set;
        }
        ...
        {
            Items.Add(new UserDataButton(UserDataActions.ClearPass, Resources.UserDataView_Button_ClearPass, MasterForm.SkinManager.GetImage("OptionsProfile")));
            Items.Add(new UserDataButton(UserDataActions.ClearCache, Resources.UserDataView_Button_ClearCache, MasterForm.SkinManager.GetImage("OptionsProfile")));
        }
        ...
        protected override void OnItemSelected(int index, Point mousePosition)
        {
            ...
            if (NativeItems[index].SecondaryText == UserDataActions.ClearPass.ToString())
            {
                NavigationService.Controllers["UserDataController"].Initialize("ClearPass");
            }
            else if (NativeItems[index].SecondaryText == UserDataActions.ClearCache.ToString())
            {
                NavigationService.Controllers["UserDataController"].Initialize("ClearCache");
            }
