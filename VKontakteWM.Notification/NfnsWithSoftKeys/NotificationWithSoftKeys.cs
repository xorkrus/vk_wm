...
namespace Galssoft.VKontakteWM.Notification.NfnsWithSoftKeys
{
  ...
  public class NotificationWithSoftKeys : Component
  {
    ...
    /// <summary>
    /// Нотификация свёрнута в трей
    /// </summary>
    public bool StraightToTray
    {
        get { return (m_data.grfFlags & SHNF.STRAIGHTTOTRAY) != 0; }
        set
        {
            if (value)
            {
            ...
            {
                m_data.grfFlags ^= (SHNF.STRAIGHTTOTRAY & m_data.grfFlags);
            }
    ...
    /// <summary>
    /// Нотификация будит устройство
    /// </summary>
    public bool DisplayOn
    {
        get { return (m_data.grfFlags & SHNF.DISPLAYON) != 0; }
        set
        {
            if (value)
            {
            ...
            {
                m_data.grfFlags ^= (SHNF.DISPLAYON & m_data.grfFlags);
            }
    ...
    public bool Visible
    {
      ...
      {
#if !DESIGN
        /*MessageBox.Show(value.ToString() + " " + mVisible.ToString());
        if (mVisible != value)
        {*/
          mVisible = value;
